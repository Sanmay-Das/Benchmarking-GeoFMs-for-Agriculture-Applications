...
class GroupChannelsVisionTransformer(timm.models.vision_transformer.VisionTransformer):
    ...
    def forward_features_seg(self, x):
        ...
        This method:
          1. Runs the same group-channel patch embedding + positional encoding
        ...
        Returns:
            ...
            Wrapped in a list for MMSeg / PSANet compatibility.
        """
        b, c, h, w = x.shape
        ...
        # Add channel + positional embeddings (same as forward_features)
