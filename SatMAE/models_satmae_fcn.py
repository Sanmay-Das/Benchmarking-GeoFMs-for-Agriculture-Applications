...
Decoder : FCNHead — adapted from Prithvi EO V1 (mmseg FCNHead)
          ...
          Main head : num_convs=1, Conv2d(1024→256,3×3)+BN+ReLU
                      → Dropout2d(0.1) → Conv2d(256→14,1×1)
                      → bilinear upsample → (B, 14, 96, 96)

          Aux head  : num_convs=2, Conv2d(1024→256,3×3)+BN+ReLU
...
class FCNHead(nn.Module):
    ...
    Args:
        ...
        num_convs    : number of 3×3 conv layers (1=main, 2=aux — Prithvi config)
