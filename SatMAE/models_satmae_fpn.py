...
Decoder : 4-scale FPN (same design as SpectralGPT SegMunich src/)
          conv0 : 1024 ->  256 @ 8x upsample -> (B,  256, 96, 96)
          conv1 : 1024 ->  512 @ 4x upsample -> (B,  512, 48, 48)
          conv2 : 1024 -> 1024 @ 2x upsample -> (B, 1024, 24, 24)
          conv3 : 1024 -> 2048 @ 1x (none)   -> (B, 2048, 12, 12)
...
class FPNHEAD(nn.Module):
    ...
    def forward(self, input_fpn):
        ...
        return self.fuse_all(torch.cat([x1, x2, x3, x4], dim=1))          # 256 @ 96x96
