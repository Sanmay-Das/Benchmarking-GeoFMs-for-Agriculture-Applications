"""
train_cd_satmae_CA.py
---------------------
SatMAE Change Detection -- California geographic split.
...
def main(args):
    ...
    # datasets -- CA split
    train_csv = [os.path.join(args.data_root, 'NorthCA_chips.csv')]
    val_csv   = [os.path.join(args.data_root, 'CentCA_chips.csv')]
    test_csv  = [os.path.join(args.data_root, 'SouthCA_chips.csv')]
    ...
    best_f1      = 0.0
    results_file = "cd_results_satmae_CA.txt"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SatMAE CD Training -- California')
    ...
    parser.add_argument('--output-dir', default='./cd_train_satmae_CA')
