...
def main(args):
    ...
    if args.test_only:
        print("test_only not supported without SouthMN chips.")
        return

    best_f1      = 0.0
    results_file = "cd_results_satmae_MN.txt"
    ...
    print("\n=== Training complete. Run inference separately on SouthMN. ===")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-dir', default='./cd_train_satmae_MN')
