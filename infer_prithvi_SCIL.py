...
CHECKPOINT   = '/bigdata/eldawylab/sdas050/MS_Research/experiments/prithvi_multi_temporal_crop_classification/IL/best_mIoU_epoch_60.pth'
...
OUTPUT_DIR   = '/bigdata/eldawylab/sdas050/MS_Research/predictions/prithvi_SCIL_terratorch'
OUTPUT_FILE  = os.path.join(OUTPUT_DIR, 'SCIL_Prithvi_Prediction_Stitched.tif')
...
# IL stats
MEANS = torch.tensor([
    1846.01041553, 2034.87291436, 2336.89914972, 3440.02626379, 4359.27030951, 3659.25810150, # Frame 1
    1695.67070792, 2004.41327354, 2071.42573572, 4374.83196041, 4280.68264476, 3443.88865098, # Frame 2
    1329.93065729, 1595.10951595, 1423.11484433, 4857.70613826, 2940.70615467, 1962.99561508  # Frame 3
], dtype=torch.float32).view(18, 1, 1)

STDS = torch.tensor([
    283.66006748, 339.71900563, 474.30990502, 668.68752993, 840.73559942, 831.40692088, # Frame 1
    346.60747720, 375.23409813, 594.97555072, 801.13507408, 1146.77483317, 1186.16430320, # Frame 2
    216.80401250, 253.46961002, 308.23907609, 1013.56374670, 484.64192366, 388.80935123  # Frame 3
], dtype=torch.float32).view(18, 1, 1)
