...
# CONFIGURATION
# ============================================================
CHECKPOINT  = f'{MSR_ROOT}/IEEE_TPAMI_SpectralGPT/downstream_tasks/SegMunich/multi_train/best_mIoU_NorthCentMN_model.pth'
STACK_PATH  = f'{MSR_ROOT}/scripts/processed_stacks/SouthMN/SouthMN_multitemporal_stack.tif'
OUTPUT_DIR  = f'{PREDICTIONS}/spectralgpt_SouthMN_terratorch'
