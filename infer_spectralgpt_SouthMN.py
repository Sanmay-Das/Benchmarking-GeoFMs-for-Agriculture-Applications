...
# CONFIGURATION
# ============================================================
CHECKPOINT  = '/bigdata/eldawylab/sdas050/MS_Research/IEEE_TPAMI_SpectralGPT/downstream_tasks/SegMunich/multi_train/best_mIoU_NorthCentMN_model.pth'
STACK_PATH  = '/bigdata/eldawylab/sdas050/MS_Research/scripts/processed_stacks/SouthMN/SouthMN_multitemporal_stack.tif'
OUTPUT_DIR  = '/bigdata/eldawylab/sdas050/MS_Research/predictions/spectralgpt_SouthMN_terratorch'
OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'SouthMN_SpectralGPT_Prediction_Stitched.tif')
...
# MN Min-Max normalization stats (used during finetuning)
GLOBAL_MIN = np.array([
