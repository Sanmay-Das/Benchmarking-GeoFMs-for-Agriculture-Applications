#!/bin/bash
#SBATCH --job-name=prithvi_cd
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --output=logs/prithvi_cd_%j_IA.out
#SBATCH --error=logs/prithvi_cd_%j_IA.err
...
python -m torch.distributed.launch --nproc_per_node=1 \
    --master_port=$MASTER_PORT --use_env train_cd_prithvi.py \
