...
# CONFIGURATION
# ============================================================
CHECKPOINT  = '/bigdata/eldawylab/sdas050/MS_Research/IEEE_TPAMI_SpectralGPT/downstream_tasks/SegMunich/multi_train/best_mIoU_NorthCentCA_model.pth'
STACK_PATH  = '/bigdata/eldawylab/sdas050/MS_Research/scripts/processed_stacks/SouthCA/SouthCA_multitemporal_stack.tif'
OUTPUT_DIR  = '/bigdata/eldawylab/sdas050/MS_Research/predictions/spectralgpt_SouthCA_terratorch'
...
# CA Min-Max normalization stats (used during finetuning)
GLOBAL_MIN = np.array([
