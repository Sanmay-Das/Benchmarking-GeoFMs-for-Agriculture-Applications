"""
Plain class-color PNG maps for SatMAE + FCN predictions (NWIA region).

Produces:
  NWIA_SatMAE_FCN_colored.png   — prediction color map
...
Usage:
  python vismap_satmae_fcn_NWIA.py
"""
...
# CONFIG
# ============================================================
PRED_PATH  = '/bigdata/eldawylab/sdas050/MS_Research/predictions/satmae_fcn_NWIA/NWIA_SatMAE_FCN_Prediction.tif'
...
if __name__ == '__main__':
    ...
    pred_out = output_dir / 'NWIA_SatMAE_FCN_colored.png'
