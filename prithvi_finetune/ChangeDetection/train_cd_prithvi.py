...
train_cd_prithvi.py
-------------------
Training script for Prithvi Change Detection benchmark.

Identical structure to train_cd_spectralgpt.py with these differences:
    - Imports CDDatasetPrithvi (z-score normalization, 224x224 chips)
    - Imports build_prithvi_cd
    - Pretrained weights: Prithvi_EO_V1_100M.pt
    - Data root: change_detection_chips/prithvi/
...
Place this file at:
    downstream_tasks/ChangeDetection/train_cd_prithvi.py

Run:
    cd downstream_tasks/ChangeDetection
...
def main(args):
    ...
    # training loop
    best_f1      = 0.0
    results_file = "cd_results_prithvi.txt"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Prithvi Change Detection Training')
    ...
    parser.add_argument('-b', '--batch_size', default=4, type=int,
                        help='Prithvi chips are 224x224 so smaller batch than SpectralGPT')
