#!/bin/bash
#SBATCH --job-name=satmae_psanet_NC_2g
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:2
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --time=09:00:00
#SBATCH --output=logs/satmae_psanet_NC_2gpu_%j.out
#SBATCH --error=logs/satmae_psanet_NC_2gpu_%j.err
...
OUTPUT_DIR="${SATMAE_DIR}/output_seg_NC_2gpu"
...
echo "=========================================="
echo "SATMAE + PSANet — NC CROP SEGMENTATION (2x A100)"
echo "=========================================="
