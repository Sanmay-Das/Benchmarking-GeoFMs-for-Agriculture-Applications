#!/bin/bash
#SBATCH --job-name=infer_cd_prithvi_SouthCA
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=2:00:00
#SBATCH --output=logs/infer_cd_prithvi_SouthCA_%j.out
#SBATCH --error=logs/infer_cd_prithvi_SouthCA_%j.err
...
python infer_cd_prithvi_SouthCA.py

echo ""
echo "==== Done ===="
ls -lh predictions/cd_prithvi_SouthCA/
