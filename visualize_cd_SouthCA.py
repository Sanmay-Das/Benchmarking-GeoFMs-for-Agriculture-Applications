...
GT_PATH = f'{PREDICTIONS}/cd_spectralgpt_SouthCA/SouthCA_SpectralGPT_CD_gt.tif'

MODELS = [
    ('Prithvi',
     f'{PREDICTIONS}/cd_prithvi_SouthCA/SouthCA_Prithvi_CD_pred.tif'),
]

OUTPUT_DIR = f'{OUTPUT_ROOT}/visualizations/cd_SouthCA'
SCALE      = 4
STRIP_H    = 256
CROP_SIZE  = 512
