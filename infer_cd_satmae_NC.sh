#!/bin/bash
#SBATCH --job-name=infer_cd_satmae_EastNC
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --output=logs/infer_cd_satmae_EastNC_%j.out
#SBATCH --error=logs/infer_cd_satmae_EastNC_%j.err
...
mkdir -p "$MSR_OUTPUT_ROOT/logs" "$MSR_OUTPUT_ROOT/predictions/cd_satmae_EastNC"

echo "==== SatMAE CD Inference -- EastNC ===="
