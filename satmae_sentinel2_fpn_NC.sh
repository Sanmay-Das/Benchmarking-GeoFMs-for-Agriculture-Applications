#!/bin/bash
#SBATCH --job-name=satmae_fpn_NC
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --time=48:00:00
#SBATCH --output=logs/satmae_fpn_NC_%j.out
#SBATCH --error=logs/satmae_fpn_NC_%j.err
...
OUTPUT_DIR="${SATMAE_DIR}/output_seg_NC_fpn"
...
echo "=========================================="
echo "SATMAE + FPN — NC CROP SEGMENTATION"
echo "=========================================="
