#!/bin/bash
#SBATCH --job-name=infer_cd_sgpt_SouthMN
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=2:00:00
#SBATCH --output=logs/infer_cd_sgpt_SouthMN_%j.out
#SBATCH --error=logs/infer_cd_sgpt_SouthMN_%j.err
...
mkdir -p "$MSR_OUTPUT_ROOT/logs" "$MSR_OUTPUT_ROOT/predictions/cd_spectralgpt_SouthMN"

echo "==== SpectralGPT CD Inference -- SouthMN ===="
...
echo ""
echo "==== Done ===="
ls -lh predictions/cd_spectralgpt_SouthMN/
