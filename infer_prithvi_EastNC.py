...
CHECKPOINT   = '/bigdata/eldawylab/sdas050/MS_Research/experiments/prithvi_multi_temporal_crop_classification/IL/best_mIoU_epoch_30.pth'
CONFIG_FILE  = '/bigdata/eldawylab/sdas050/MS_Research/prithvi_finetune/configs/multi_temporal_crop_classification.py'
STACK_PATH   = '/bigdata/eldawylab/sdas050/MS_Research/scripts/processed_stacks/EastNC/EastNC_multitemporal_stack.tif'
OUTPUT_DIR   = '/bigdata/eldawylab/sdas050/MS_Research/predictions/prithvi_EastNC_terratorch'
OUTPUT_FILE  = os.path.join(OUTPUT_DIR, 'EastNC_Prithvi_Prediction_Stitched.tif')
...
# NC stats
MEANS = torch.tensor([
    1615.22474433, 1919.88049677, 1907.57302125, 4391.62877790, 3639.24284624, 2772.85214380, # T1
    1402.42608964, 1646.00419386, 1490.97300540, 4668.59382492, 3072.37737136, 2090.55866365, # T2
    1377.28325829, 1549.71437673, 1419.84248805, 4144.49420760, 2819.86398661, 1957.26925153  # T3
], dtype=torch.float32).view(18, 1, 1)

STDS = torch.tensor([
    445.83556981, 508.25045142, 765.69735543, 659.43243087, 1163.39733358, 1223.01516809, # T1
    276.18115909, 339.45512187, 419.55339594, 1044.42051202, 757.69613288, 650.64448343, # T2
    243.51106275, 291.01566979, 364.48130790, 920.12017449, 660.86197671, 555.53329805  # T3
], dtype=torch.float32).view(18, 1, 1)
