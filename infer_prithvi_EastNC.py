...
CHECKPOINT   = f'{OUTPUT_ROOT}/experiments/prithvi_multi_temporal_crop_classification/IL/best_mIoU_epoch_30.pth'
...
OUTPUT_DIR   = f'{PREDICTIONS}/prithvi_EastNC_terratorch'
