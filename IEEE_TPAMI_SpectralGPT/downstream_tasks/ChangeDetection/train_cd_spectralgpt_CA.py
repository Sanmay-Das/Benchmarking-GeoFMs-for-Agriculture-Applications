"""
train_cd_spectralgpt_CA.py
--------------------------
SpectralGPT Change Detection -- California geographic split.
...
def main(args):
    ...
    best_f1      = 0.0
    results_file = "cd_results_spectralgpt_CA.txt"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SpectralGPT CD Training -- California')
    ...
    parser.add_argument('--output-dir', default='./cd_train_spectralgpt_CA')
