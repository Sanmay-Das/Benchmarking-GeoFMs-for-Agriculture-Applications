"""
train_cd_spectralgpt_NC.py
--------------------------
SpectralGPT Change Detection — North Carolina geographic split.
...
def main(args):
    ...
    best_f1      = 0.0
    results_file = "cd_results_spectralgpt_NC.txt"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SpectralGPT CD Training — North Carolina')
    ...
    parser.add_argument('--output-dir', default='./cd_train_spectralgpt_NC')
