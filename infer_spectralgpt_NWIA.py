...
# CONFIGURATION
# ============================================================
CHECKPOINT  = str(seg_checkpoint('spectralgpt', 'NWIA', ''))
...
GLOBAL_MIN = np.array([
    296.00, 1090.00,  798.00,  929.00, 1079.00, 1079.00,   # T1
    525.00, 1076.00,  892.00, 1009.00, 1072.00, 1028.00,   # T2
    289.00,  748.00,  844.00,  978.00, 1031.00, 1022.00    # T3
