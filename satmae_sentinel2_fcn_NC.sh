#!/bin/bash
#SBATCH --job-name=satmae_fcn_NC
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --time=48:00:00
#SBATCH --output=logs/satmae_fcn_NC_%j.out
#SBATCH --error=logs/satmae_fcn_NC_%j.err
...
OUTPUT_DIR="${SATMAE_DIR}/output_seg_NC_fcn"
...
echo "=========================================="
echo "SATMAE + FCNHead — NC CROP SEGMENTATION"
echo "=========================================="
